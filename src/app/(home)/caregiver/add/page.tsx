      ...
      <div className="max-w-2/4 mx-auto bg-white rounded-lg shadow-sm">
        <div className="p-6 space-y-6">
          ...
          <button
            ...
            className="w-full gap-2 bg-[#2E8BC9] hover:bg-blue-600 text-white font-medium py-3 px-4 rounded-md transition-colors duration-200 flex items-center justify-center"
          >
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
