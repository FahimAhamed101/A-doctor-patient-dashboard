// app/doctor/book-confirm/[id]/page.tsx
'use client'

import { useState } from 'react';
import { useParams } from 'next/navigation';
import { useGetAppointmentDetailsQuery } from '@/redux/features/appointments/appointmentsApi';
...
export default function BookingConfirmation() {
  ...
  const { data: appointmentResponse, isLoading, error } = useGetAppointmentDetailsQuery(appointmentId);
  ...
  const handleShare = (platform: string) => {
    ...
    const message = `Booking Confirmed! Appointment ID: ${appointment._id} - ${appointmentDate} with Dr. ${appointment.doctorId.fullName}`;
      ...
      <div className="min-h-screen flex items-center justify-center px-4">
        <div className="max-w-md w-full rounded-lg p-8 text-center">
          ...
          <p className="text-gray-500 mb-6">
            We couldn't find the appointment details. Please check your booking history.
          </p>
          <Link 
      ...
      <div className="max-w-md w-full rounded-lg p-8 text-center">
        ...
        <div className="mb-6">
          ...
          <p className="text-gray-600 text-xs mt-1">
            {appointment.doctorId.discipline}
          </p>
        ...
        <div className="bg-gray-50 rounded-lg p-4 mb-6 text-left">
          ...
          <div className="space-y-1 text-sm text-gray-600">
            <p><span className="font-medium">Reason:</span> {appointment.visitReason}</p>
            <p><span className="font-medium">Type:</span> {appointment.visitType}</p>
        ...
        <div className="mt-4 flex gap-2">
          <Link 
            href="/my-appointments"
            className="flex-1 border border-[#2E8BC9] text-[#2E8BC9] hover:bg-blue-50 font-medium py-2 px-4 rounded-md transition-colors duration-200 text-center"
          >
            View All Appointments
          </Link>
          <Link 
            href="/doctor-search"
            className="flex-1 border border-gray-300 text-gray-700 hover:bg-gray-50 font-medium py-2 px-4 rounded-md transition-colors duration-200 text-center"
          >
            Book Another
          </Link>
        </div>
