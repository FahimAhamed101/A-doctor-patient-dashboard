...
<g clip-path="url(#clip0_737_13330)">
<path d="M42.5 75.5859C59.6899 75.5859 73.625 61.6508 73.625 44.4609C73.625 27.2711 59.6899 13.3359 42.5 13.3359C25.3101 13.3359 11.375 27.2711 11.375 44.4609C11.375 61.6508 25.3101 75.5859 42.5 75.5859Z" stroke="#2E8BC9" stroke-width="5.1875" stroke-linecap="round"/>
<path d="M18.2917 65.2109L11.375 72.1276M66.7083 65.2109L73.625 72.1276" stroke="#2E8BC9" stroke-width="5.1875" stroke-linecap="round" stroke-linejoin="round"/>
<path d="M66.7087 11.8452L68.7681 10.8155C71.6914 9.3539 72.7895 9.52118 75.1135 11.8452C77.4375 14.1692 77.6048 15.2674 76.143 18.1906L75.1135 20.25M18.292 11.8452L16.2326 10.8155C13.3094 9.3539 12.2112 9.52118 9.88721 11.8452C7.56318 14.1692 7.3959 15.2674 8.85749 18.1906L9.88721 20.25" stroke="#2E8BC9" stroke-width="5.1875" stroke-linecap="round"/>
<path fill-rule="evenodd" clip-rule="evenodd" d="M55.0392 34.1466C56.1796 35.1249 56.3257 36.8597 55.3653 38.0214L41.7231 54.5214C41.2236 55.1256 40.4932 55.4817 39.7178 55.4993C38.9426 55.5169 38.1972 55.1941 37.672 54.613L29.714 45.8131C28.7038 44.696 28.774 42.9561 29.8708 41.9273C30.9676 40.8983 32.6758 40.9698 33.686 42.0868L39.5671 48.5905L51.2346 34.4787C52.1953 33.317 53.8984 33.1682 55.0392 34.1466Z" fill="#2E8BC9"/>
<path d="M42.5 11.6016V6.41406" stroke="#2E8BC9" stroke-width="5.1875" stroke-linecap="round" stroke-linejoin="round"/>
<path d="M35.584 6.41406H49.4173" stroke="#2E8BC9" stroke-width="5.1875" stroke-linecap="round" stroke-linejoin="round"/>
</g>
<defs>
<clipPath id="clip0_737_13330">
<rect width="84" height="83" fill="white"/>
        ...
        <div className="mb-6">
          ...
          <p className="text-gray-500 text-sm">
           We’ll notify you if an earlier appointment opens up.
          </p>
        </div>
...
<path d="M18.9531 23.4531L3.57812 37.7031L20.1081 24.5106L18.9531 23.4531Z" fill="#E7B95E"/>
            ...
            <button 
              onClick={closePopup}
              className="w-full   border-t-1  text-[#2E8BC9] py-3 px-4 border-[#DCDCDC] text-sm font-medium transition-colors duration-200"
            >
              Send Message
            </button>
          </div>
